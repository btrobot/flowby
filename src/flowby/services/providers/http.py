...
class HttpProvider(ServiceProvider):
    ...
    def __init__(self, name: str, config: Dict[str, Any], settings, **kwargs):
        """
        初始化 HTTP 提供者
    ...
    def delete(self, url: str, params: Optional[Dict[str, Any]] = None, **kwargs) -> Dict[str, Any]:
        """
        发送 DELETE 请求
    ...
    def request(self, http_method: str, url: str, **kwargs) -> Dict[str, Any]:
        """
        通用 HTTP 请求方法
    ...
    def _request(self, method: str, url: str, **kwargs) -> Dict[str, Any]:
        ...
        if not self.session:
            raise ServiceError(
                "HTTP Session 未初始化，请先调用 initialize()", provider=self.name, method=method
            )
        ...
        try:
            ...
            response = self.session.request(
                method=method, url=url, headers=headers, timeout=timeout, verify=verify, **kwargs
            )
    ...
    def _parse_response(self, response: requests.Response, elapsed: float) -> Dict[str, Any]:
        """
    ...
    def _handle_error(
        self, error: Exception, url: str, elapsed: float, message: str
    ) -> Dict[str, Any]:
        """
