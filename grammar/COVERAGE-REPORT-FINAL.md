...
| expr-level4 | Expression Level 4: ==, !=, >, <, >=, <= | ✅ | test_expressions.py |
| expr-level5 | Expression Level 5: +, - | ✅ | test_expressions.py |
| expr-level6 | Expression Level 6: *, /, % | ✅ | test_expressions.py |
| expr-level7 | Expression Level 7: Unary -, not | ✅ | test_expressions.py |
| expr-level8 | Expression Level 8: ., [], () | ✅ | test_expressions.py |
| expr-level9 | Expression Level 9: Literals, Variables | ✅ | test_expressions.py |
...
| 3.2 | Go Back/Forward | ✅ | test_03_navigation.py |
