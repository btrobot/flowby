...
class TestTypeConversion:
    ...
    def test_to_boolean_with_numbers(self):
        ...
        assert to_boolean(0) == False, \
            "0 应该转换为 False"
        assert to_boolean(42) == True, \
            "非零数字应该转换为 True"

    def test_to_boolean_with_strings(self):
        """测试字符串转布尔"""
        # Arrange & Act & Assert
        assert to_boolean("hello") == True, \
            "非空字符串应该转换为 True"
...
class TestSystemVariableEvaluation:
    ...
    def evaluator(self):
        ...
        system_vars = SystemVariables(
            context=context,
            config_vars={"api": {"token": "secret123", "timeout": 30}}
        )
        return ExpressionEvaluator(symbol_table, system_vars)
...
class TestArithmeticOperations:
    ...
    def test_multiplication(self, evaluator):
        ...
        # Arrange
        expr = BinaryOp(
            left=Literal(value=6, line=1),
            operator="*",
            right=Literal(value=7, line=1),
            line=1
        )
...
class TestLogicalOperations:
    ...
    def test_not_false(self, evaluator):
        ...
        expr = UnaryOp(
            operator="NOT",
            operand=Literal(value=False, line=1),
            line=1
        )
    ...
    def test_not_true(self, evaluator):
        ...
        expr = UnaryOp(
            operator="NOT",
            operand=Literal(value=True, line=1),
            line=1
        )
...
class TestStringOperations:
    ...
    def test_contains_operator(self, evaluator):
        ...
        # Assert
        assert result == True, \
            "'hello world' contains 'world' 应该为 True"
...
class TestMemberAccess:
    ...
    def evaluator(self):
        ...
        symbol_table.define(
            "user",
            {"email": "alice@example.com", "id": 123},
            SymbolType.VARIABLE,
            0
        )
    ...
    def test_access_object_property(self, evaluator):
        ...
        assert result == "alice@example.com", \
            "user.email 应该返回 'alice@example.com'"
...
class TestArrayAccess:
    ...
    def test_various_array_indices(self, evaluator, index, expected):
        ...
        expr = ArrayAccess(
            array=Identifier(name="items", line=1),
            index=Literal(value=index, line=1),
            line=1
        )
...
class TestStringInterpolation:
    ...
    def test_simple_interpolation(self, evaluator):
        ...
        assert result == "Hello alice!", \
            "'Hello {username}!' 应该返回 'Hello alice!'"
    ...
    def test_interpolation_with_expression(self, evaluator):
        ...
        assert result == "Age: 30", \
            "'Age: {age + 5}' 应该返回 'Age: 30' (v4.0 整数类型)"
...
class TestComplexExpressions:
    ...
    def test_comparison_with_logical_and(self, evaluator):
        ...
        # Assert
        assert result == True, \
            "age > 18 AND username == 'alice' 应该为 True"
